        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">DÉVÉLOPPEUR WEB</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
                    <img src="img-beeweb\dev.png" class="img-responsive" alt="">
                </div>
                <div class="col-sm-6 padding-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
                    <h2>Dévéloppeur front-end</h2>
                    <p>Le développeur front end travaille sur l'intégration de l'interface  visuel du site ou l'application mobile avec laquelle les internautes sont en contact. 
                    Il est sensé maîtriser les outils essentielles et langages de programmations basics : HTML , CSS et Javascript .<br>
                    Il doit aussi maîtriser l'utilisation des frameworks comme Bootstrap en CSS ; jQuery pour JS et biens d'autres... 
                    Il assurer la cohérence de comportement sur tous les appareils utilisés pour utiliser l’application ou le site web qu’il développe : Responsive, Progressive ou Adaptive.</p>
                    <h2>Dévéloppeur back-end</h2>
